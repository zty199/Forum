...
<body background="images/index.jpg">
	...
	<!--  
       ...
       <input type="button" value="个人中心" onclick="window.location.href='/Forum/jsp/PersonalInformation.jsp';" class="buttoncenter"/>
       -->
       <br> <br> <br> <br> <br><br>
 <div>
            ...
            <ul class="hottopiclist1">
                  <li class="hottopicli">
                    <label class="hotlabel">
                      ...
                      <a href="/Forum/jsp/replytiezi.jsp" class="topic_title" target="_blank" title="有关点击js点击事件深层问题求助">有关点击js点击事件深层问题求助</a>
                    </label>
                  ...
                  <li class="hottopicli">
                    <label class="hotlabel">
                      ...
                      <em class="classify_dot">・</em>
                      <a href="/Forum/jsp/replytiezi.jsp" class="topic_title" target="_blank" title="有微软的吗？有人说String.IsNullOrEmpty函数有BUG至今未被修复">有微软的吗？有人说String.IsNullOrEmpty函数有BUG至今未被修复</a>
                    </label>
                  ...
                  <li class="hottopicli">
                    <label class="hotlabel">
                      ...
                      <em class="classify_dot">・</em>
                      <a href="/Forum/jsp/replytiezi.jsp" class="topic_title" target="_blank" title="页面查询数据查询超过两万条数据时无法显示？？？">页面查询数据查询超过两万条数据时无法显示？？？</a>
                    </label>
